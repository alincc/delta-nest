...
const receive_payment_dto_1 = require("../../dtos/receive-payment.dto");
const payment_interface_1 = require("../../interfaces/payment.interface");
let PaymentController = class PaymentController {
    constructor(paymentControllerService) {
    ...
    async createOne(payment, response) {
        return this.paymentControllerService
            .createOne(payment)
            .then((success) => {
            return response.status(201).json(success);
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [receive_payment_dto_1.ReceivePaymentDto, Object]),
    __metadata("design:returntype", Promise)
], PaymentController.prototype, "createOne", null);
__decorate([
    roles_decorator_1.Roles("PRINCIPAL_ROLE"),
    common_1.UseGuards(passport_1.AuthGuard("jwt"), roles_guard_1.RolesGuard),
    common_1.Put(":id"),
...
], PaymentController.prototype, "updateOne", null);
__decorate([
    roles_decorator_1.Roles("PRINCIPAL_ROLE"),
    common_1.UseGuards(passport_1.AuthGuard("jwt"), roles_guard_1.RolesGuard),
    common_1.Delete(":id"),
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], PaymentController.prototype, "deleteOne", null);
__decorate([
    roles_decorator_1.Roles("PRINCIPAL_ROLE"),
    common_1.UseGuards(passport_1.AuthGuard("jwt"), roles_guard_1.RolesGuard),
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], PaymentController.prototype, "findAllInSchool", null);
__decorate([
    roles_decorator_1.Roles("PRINCIPAL_ROLE", "STUDENT_ROLE"),
    common_1.UseGuards(passport_1.AuthGuard("jwt"), roles_guard_1.RolesGuard),
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], PaymentController.prototype, "findAllInStudent", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], PaymentController.prototype, "checkFolio", null);
PaymentController = __decorate([
    common_1.Controller("payments"),
    __metadata("design:paramtypes", [payment_service_1.PaymentControllerService])
], PaymentController);
